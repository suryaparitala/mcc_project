...
public class SignupActivity extends AppCompatActivity {
    ...
    public static  String imei_val = null;
    ...
    public void signup() {
        ...
        login_info = (HashMap<String, String>) sharedpreferences.getAll();

        if(login_info.containsKey(imei_val)){
            Toast.makeText(getBaseContext(), " Account already exists ", Toast.LENGTH_LONG).show();

            _signupButton.setEnabled(true);
        }
        else{
            editor.putString(email,imei_val);
            _signupButton.setEnabled(true);
            Intent intentmenu = new Intent(SignupActivity.this, menu.class);
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_READ_CONTACTS: {
                ...
                if (grantResults.length > 0
                    ...
                    imei_val =  telephonyManager.getDeviceId();
